# Spec/Agent — AI Product Manager (MERN + Groq)

Type a one-line product idea (e.g. *"Build a food delivery app"*) and get a full
product-planning package generated by Groq:
